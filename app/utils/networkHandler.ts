...
/**
 * Vérifie si Pusher est connecté
 */
export const getPusherConnectionState = (): string => {
  // Cette fonction sera utilisée pour vérifier l'état de Pusher
  // Elle peut être étendue pour accéder à l'instance Pusher si nécessaire
  return 'unknown';
};
