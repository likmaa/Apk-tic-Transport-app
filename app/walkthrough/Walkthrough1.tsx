...
export default function Walkthrough1() {
  ...
  const handlePress = () => {
    router.push("/walkthrough/Walkthrough2");
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        {/* Titre */}
        <Text style={styles.title}>Bienvenue sur TIC-MITON</Text>

        {/* Description */}
        <Text style={styles.desc}>
          Gérez vos trajets facilement  et en toute sécurité  avec notre application intuitive et rapide.
        </Text>
...
const styles = StyleSheet.create({
  ...
  nextButton: {
    ...
    paddingVertical: 10,
    borderRadius: 10,
    elevation: 3, // petite ombre Android
